...
#define MG_ERR_SERVICE_UNAVAILABLE (-27)
#define MG_ERR_QUEUE_FULL       (-28)
#define MG_ERR_PROTOCOL         (-29)
#define MG_ERR_TIME_UNAVAILABLE (-30)
#define MG_ERR_DEVICE_GONE      (-31)
#define MG_ERR_RETRY            (-32)
